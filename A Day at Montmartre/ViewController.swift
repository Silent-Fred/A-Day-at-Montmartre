...
class ViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    private func restartApproximatorOnTargetImageWithCurrentSettings() {
        ...
        if approximationStyle == SettingsBundleHelper.ApproximationStyle.basicGenetic {
            approximator = BasicGeneticApproximator(imageToApproximate: imageToApproximate,
                                                    using: shapeStyle)
        } else {
    ...
    private func approximationStyleSettingsChanged() -> Bool {
        ...
        case .basicGenetic?:
            return !(approximator is BasicGeneticApproximator)
        default:
